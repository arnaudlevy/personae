...
ActiveRecord::Schema.define(version: 2020_02_27_105350) do
  ...
  create_table "evaluations", force: :cascade do |t|
    ...
    t.index ["person_id"], name: "index_evaluations_on_person_id"
    t.index ["variable_id"], name: "index_evaluations_on_variable_id"
  end
  ...
  create_table "people", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["study_id"], name: "index_people_on_study_id"
  end
